...
fc=input('Enter the freq of Sine Wave carrier:'); %80
fp=input('Enter the freq of Periodic Binary pulse (Message):'); %10
amp=input('Enter the amplitude (For Carrier & Binary Pulse Message):'); %4
